...
require (
	...
	k8s.io/cluster-bootstrap v0.28.12
	...
	k8s.io/dynamic-resource-allocation v0.28.12
	k8s.io/endpointslice v0.28.12
	k8s.io/gengo v0.0.0-20220902162205-c0856e24416d
	k8s.io/klog/v2 v2.100.1
	k8s.io/kms v0.28.12
	k8s.io/kube-aggregator v0.28.12
	k8s.io/kube-controller-manager v0.28.12
	k8s.io/kube-openapi v0.0.0-20230717233707-2695361300d9
	k8s.io/kube-proxy v0.28.12
	k8s.io/kube-scheduler v0.28.12
	k8s.io/kubectl v0.28.12
	k8s.io/kubelet v0.28.12
	k8s.io/legacy-cloud-providers v0.28.12
	k8s.io/metrics v0.28.12
	k8s.io/mount-utils v0.28.12
	k8s.io/pod-security-admission v0.28.12
	k8s.io/sample-apiserver v0.28.12
