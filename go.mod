...
require (
	...
	k8s.io/csi-translation-lib v0.26.15
	k8s.io/dynamic-resource-allocation v0.26.15
	k8s.io/gengo v0.0.0-20220902162205-c0856e24416d
	k8s.io/klog/v2 v2.80.1
	k8s.io/kms v0.26.15
	k8s.io/kube-aggregator v0.26.15
	k8s.io/kube-controller-manager v0.26.15
	k8s.io/kube-openapi v0.0.0-20221012153701-172d655c2280
	k8s.io/kube-proxy v0.26.15
	k8s.io/kube-scheduler v0.26.15
	k8s.io/kubectl v0.26.15
	k8s.io/kubelet v0.26.15
	k8s.io/legacy-cloud-providers v0.26.15
	k8s.io/metrics v0.26.15
	k8s.io/mount-utils v0.26.15
	k8s.io/pod-security-admission v0.26.15
	k8s.io/sample-apiserver v0.26.15
