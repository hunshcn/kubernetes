...
require (
	...
	k8s.io/cluster-bootstrap v0.27.12
	...
	k8s.io/cri-api v0.27.12
	k8s.io/csi-translation-lib v0.27.12
	k8s.io/dynamic-resource-allocation v0.27.12
	k8s.io/gengo v0.0.0-20220902162205-c0856e24416d
	k8s.io/klog/v2 v2.90.1
	k8s.io/kms v0.27.12
	k8s.io/kube-aggregator v0.27.12
	k8s.io/kube-controller-manager v0.27.12
	k8s.io/kube-openapi v0.0.0-20230501164219-8b0f38b5fd1f
	k8s.io/kube-proxy v0.27.12
	k8s.io/kube-scheduler v0.27.12
	k8s.io/kubectl v0.27.12
	k8s.io/kubelet v0.27.12
	k8s.io/legacy-cloud-providers v0.27.12
	k8s.io/metrics v0.27.12
	k8s.io/mount-utils v0.27.12
	k8s.io/pod-security-admission v0.27.12
	k8s.io/sample-apiserver v0.27.12
