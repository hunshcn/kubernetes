...
require (
	...
	k8s.io/cluster-bootstrap v0.29.11
	...
	k8s.io/csi-translation-lib v0.29.11
	k8s.io/dynamic-resource-allocation v0.29.11
	k8s.io/endpointslice v0.29.11
	k8s.io/gengo v0.0.0-20230829151522-9cce18d56c01
	k8s.io/klog/v2 v2.110.1
	k8s.io/kms v0.29.11
	k8s.io/kube-aggregator v0.29.11
	k8s.io/kube-controller-manager v0.29.11
	k8s.io/kube-openapi v0.0.0-20231010175941-2dd684a91f00
	k8s.io/kube-proxy v0.29.11
	k8s.io/kube-scheduler v0.29.11
	k8s.io/kubectl v0.29.11
	k8s.io/kubelet v0.29.11
	k8s.io/legacy-cloud-providers v0.29.11
	k8s.io/metrics v0.29.11
	k8s.io/mount-utils v0.29.11
	k8s.io/pod-security-admission v0.29.11
	k8s.io/sample-apiserver v0.29.11
